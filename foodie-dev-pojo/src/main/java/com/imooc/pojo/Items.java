...
public class Items {
     ...
     * 获取一级分类外键id;一级分类外键id
     *
     * @return root_cat_id - 一级分类外键id;一级分类外键id
     */
     ...
     * 设置一级分类外键id;一级分类外键id
     *
     * @param rootCatId 一级分类外键id;一级分类外键id
     */
     ...
     * 获取上下架状态;上下架状态
     *
     * @return on_off_status - 上下架状态;上下架状态
     */
